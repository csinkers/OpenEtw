...
// This can then be activated in PerfView, Perspex etc by specifying the name with a * after it.
...
#define ETW_HEADER(...) // If this appears in the header, then the implementation will include the given filename, defaulting to "stdafx.h" if none is supplied.
